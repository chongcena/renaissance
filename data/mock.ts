...
export const action_log: ActionLog[] = [
  { id: 'ac-01', action: 'Routed Spark to 2 pathways', action_type: 'route', countsForStreak: true, date: '2026-05-16' },
  { id: 'ac-02', action: 'Completed Heat Check on Writing branch', action_type: 'diagnostic', countsForStreak: true, date: '2026-05-15' },
  { id: 'ac-03', action: 'Logged Blaze and minted Burner', action_type: 'create_blaze', countsForStreak: true, date: '2026-05-14' },
  { id: 'ac-04', action: 'Opened dashboard', action_type: 'open_app', countsForStreak: false, date: '2026-05-13' }
];
